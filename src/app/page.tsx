...
import { Download, Play, Smartphone, Zap, Music, Users, Heart, Globe, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden pt-24 pb-12 sm:pt-32 sm:pb-16 lg:pt-48 lg:pb-32">
          ...
          <div className="absolute top-0 left-1/2 -z-10 -translate-x-1/2 blur-3xl" aria-hidden="true">
            <div className="aspect-[1097/845] w-[40rem] sm:w-[68rem] bg-gradient-to-tr from-primary to-secondary opacity-10" style={{ clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)' }}></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                ...
                <div className="flex items-center justify-center lg:justify-start">
                  <Button size="lg" className="w-full max-w-xs sm:w-auto rounded-full h-13 sm:h-14 px-8 text-base shadow-lg transition-all hover:shadow-primary/25 hover:scale-[1.02]" asChild>
                    <a href={APK_URL} target="_blank" rel="noopener noreferrer">
                ...
                <div className="mt-8 sm:mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-6">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-2 bg-primary/5 border border-primary/10 rounded-full px-3 py-1.5 sm:px-0 sm:py-0 sm:bg-transparent sm:border-0">
                      <Icon className="h-4 w-4 text-primary shrink-0" />
                      <span className="text-xs sm:text-sm font-semibold sm:font-medium text-foreground sm:text-muted-foreground whitespace-nowrap">{label}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
        ...
        <section id="interface" className="py-16 sm:py-24 overflow-hidden bg-background">
          ...
          <div className="relative w-full flex flex-col items-center">
            {/* Carousel container — padding gives space for arrows on mobile */}
            <div className="relative flex justify-center items-center h-[500px] sm:h-[600px] w-full px-16 sm:px-20 max-w-sm">
              ...
              {/* Arrows — positioned outside phone, inside padded container */}
              <button onClick={prevSlide} className="absolute left-0 z-30 p-2.5 sm:p-3 rounded-full bg-background/80 backdrop-blur-md border border-border/50 text-foreground hover:bg-primary/20 active:scale-95 transition-all shadow-lg cursor-pointer">
                <ChevronLeft className="w-5 h-5 sm:w-6 sm:h-6" />
              </button>
              <button onClick={nextSlide} className="absolute right-0 z-30 p-2.5 sm:p-3 rounded-full bg-background/80 backdrop-blur-md border border-border/50 text-foreground hover:bg-primary/20 active:scale-95 transition-all shadow-lg cursor-pointer">
